...
# Load the Excel file
file_path = "T30.xlsx"  # Replace with your actual file path
...
# Customize the plot
plt.title("Reverberation Time (T30) with different AM Materials as Ceiling", fontsize=18)
plt.xlabel("Frequency (Hz)", fontsize=16)
plt.ylabel("T30 in s", fontsize=16)
...
plt.ylim(0.30, 0.725)  # Set y-axis limits
plt.yticks(np.arange(0.275, 0.725, 0.025), fontsize=12)  # Set ticks at intervals of 0.025
...
# Show the plot
output_file = "T30_Threads_Narrow_YAxis.png"
